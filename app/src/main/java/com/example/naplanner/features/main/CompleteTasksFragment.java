...
import com.example.naplanner.adapter.CompleteTaskRecycleAdapter;
...
public class CompleteTasksFragment extends Fragment implements TaskItemListener {
    ...
    private void setupRecyclerView() {
        ...
        tasks = new ArrayList<>();
        CompleteTaskRecycleAdapter adapter = new CompleteTaskRecycleAdapter(tasks, this, getContext());
