...
public class CompleteTaskRecycleAdapter  extends RecyclerView.Adapter<CompleteTaskRecycleAdapter.ViewHolder>{
    private ArrayList<TaskModel> tasks;
    private TaskItemListener listener;
    private Context context;

    public CompleteTaskRecycleAdapter(ArrayList<TaskModel> tasks, TaskItemListener listener, Context context) {
        this.tasks = tasks;
    ...
    @NonNull
    @Override
    public CompleteTaskRecycleAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        return new CompleteTaskRecycleAdapter.ViewHolder(TasksListItemBinding.inflate(LayoutInflater.from(viewGroup.getContext()), viewGroup, false));
    }

    @Override
    public void onBindViewHolder(@NonNull CompleteTaskRecycleAdapter.ViewHolder holder, int position) {
        int pos = position;
